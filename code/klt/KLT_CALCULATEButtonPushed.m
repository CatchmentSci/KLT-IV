...
function KLT_CALCULATEButtonPushed(app, z1)
...
if cont == 1
    ...
    elseif strcmp(app.InterpolationMethod.Value, 'Constant Froude') == 1
        ...
        if graphics == 1 %all new
            ...
            elseif zzz == 2
                inputText = '[B]';
                ano2 = annotation(gcf,'textbox',...
                [0.842400881057317 0.612367160823138 0.0351184496513641 0.0295281577872359],...
                'String',{inputText},...
                'FitBoxToText','on',...
                'Interpreter','LaTex',...
                'FontSize', 18,...
            ...
            if zzz == 1
                ...
                annotation(gcf,'arrow',[0.650756693830035 0.877764842840512],...
                    [0.642313546423135 0.539573820395736]);

                annotation(gcf,'textarrow',...
                    [0.79860302677532 0.79860302677532],...
                    [0.587455838648398 0.587455838648398],...
                ...
                % build a legend
                [lgnd, objh] = legend('Camera Position', 'GCP Locations',...
                    'Interpreter','latex',...
                    'fontsize', 18,...
                    'NumColumns',2,...
                    'TextColor', [0.1500, 0.1500, 0.1500]);

                objhl = findobj(objh, 'type', 'patch');
                set(objhl, 'Markersize', 16);
                legend('boxoff');
                set(lgnd,'Position',[0.2726    0.5482    0.1313    0.0473])
            end
...
KLT_edit_discharge_report(app,absDistance, depthUse, QuadraticVelocity, CubicVelocity, froudeVelocity, missingInd, cellArea, totalQ_froude, totalQ_quad, totalQ_cubic, wetted_width, z1 );
